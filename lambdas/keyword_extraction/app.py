...
SYSTEM_PROMPT = (
    "You are a biomedical text mining specialist. Analyze the research paper provided below and extract "
    "important biomedical keywords grouped into the following categories. Present each category with a "
    "bold header followed by a comma-separated list of terms found in the paper:\n\n"
    "**Genes**\n"
    "**Proteins**\n"
    "**Diseases**\n"
    "**Drugs**\n"
    ...
    "Only extract terms explicitly mentioned in the paper. Do not add terms from your own knowledge. "
    "If no terms are found in a category, write \"None identified\"."
)
